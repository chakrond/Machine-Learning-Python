...
labels_ts = torch.tensor(data_z['boolQuality'].values).float()
...
model_params_0      = [2]
model_params_1      = activation_funs
...
plt.legend([f'act fun = {i}'for i in model_params_1])
plt.show()

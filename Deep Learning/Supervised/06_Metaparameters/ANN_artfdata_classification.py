...
plt.plot(data_np[np.where(labels_np==0)[0],0],data_np[np.where(labels_np==0)[0],1],'bs',alpha=.5)
plt.plot(data_np[np.where(labels_np==1)[0],0],data_np[np.where(labels_np==1)[0],1],'ko',alpha=.5)
plt.plot(data_np[np.where(labels_np==2)[0],0],data_np[np.where(labels_np==2)[0],1],'r^',alpha=.5)

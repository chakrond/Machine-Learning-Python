...
learningRates = np.logspace(np.log10(.0001),np.log10(.1),5)
optimTypes = ['SGD','RMSprop','Adam']

model_params_0 = optimTypes
model_params_1 = learningRates
...
plt.ylabel('Accuracy')
plt.legend([f'optim {param} - Train' for param in model_params_0] + [f'optim {param} - Test' for param in model_params_0])
plt.title('Optimizer by learning rate')

...
y_plot_1 = np.mean(np.array(list_losses_train_params_0[0][:10]), axis=0)
y_plot_2 = np.mean(np.array(list_losses_train_params_0[0][10:]), axis=0)
...
plt.xlabel('Epoch')
plt.ylabel('Loss')
plt.title(f'Loss by Epoch(Train set) - t={round(t, 1)}, p={round(p, 1)}')
...
# plt.plot(np.arange(1, epochs+1), y_plot_1, linewidth=1)
y_plot_1 = np.mean(np.array(list_acc_ep_test_params_0[0][:10]), axis=0)
y_plot_2 = np.mean(np.array(list_acc_ep_test_params_0[0][10:]), axis=0)
t, p = stats.ttest_ind(y_plot_1, y_plot_2)
plt.plot(np.arange(1, epochs+1), y_plot_1, linewidth=1)
plt.plot(np.arange(1, epochs+1), y_plot_2, linewidth=1)
# plt.plot(np.arange(1, epochs+1), y_plot_2, 'k', linewidth=1)
plt.xlabel('Epoch')
plt.ylabel('Loss')
plt.title(f'Loss by Epoch(test set) - t={round(t, 1)}, p={round(p, 1)}')
# plt.legend([f'{param}' for param in model_params_1] + ['Mean'])
plt.legend(['Kaiming', 'Xavier'])

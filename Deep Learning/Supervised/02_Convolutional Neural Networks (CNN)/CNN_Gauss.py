...
for i in range(len(labels)):
    ...
    # add random noise
    G  = G + np.random.randn(imgSize, imgSize)/3
...
#%% explore the filter(weight) at convolution layer

# conv layer's weight
layerW1 = CNN_model.layers[f'conv0'].weight
...
# conv layer's weight
layerW2 = CNN_model.layers[f'conv1'].weight

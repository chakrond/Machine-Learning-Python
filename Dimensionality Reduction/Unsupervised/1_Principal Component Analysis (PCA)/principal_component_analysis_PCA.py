...
for (i, clf) in enumerate(classifiers):
    ...
    ConfusionMatrixDisplay.from_estimator(clf, pca_X_test, y_test, ax=axes.flatten()[i], colorbar=False)
...
X_set, y_set = pca_X_train, y_train

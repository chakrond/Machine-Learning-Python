...
for n in range(0, N):
    ...
    if (n == 0):
        ...
        # Selection History Plot
        plt.subplot(2, 2, 1)
        max_lim  = max([bar.get_width() for bar in plot_bar_UCB])
        offset_X = 0.1 * max_lim
        plt.xlim([0, max_lim + offset_X])
        plot_bar_UCB[ad_UCB].set_width(plot_bar_UCB[ad_UCB].get_width() + 1)
        ...
        # Reward Plot
        plt.subplot(2, 2, 2)
        max_lim  = max([bar.get_width() for bar in plot_bar_rew_UCB])
        offset_X = 0.1 * max_lim
        ...
        # Selection History Plot
        plt.subplot(2, 2, 3)
        max_lim  = max([bar.get_width() for bar in plot_bar_TS])
        offset_X = 0.1 * max_lim
        plt.xlim([0, max_lim + offset_X])
        plot_bar_TS[ad_TS].set_width(plot_bar_TS[ad_TS].get_width() + 1)
        ...
        # Reward Plot
        plt.subplot(2, 2, 4)
        max_lim  = max([bar.get_width() for bar in plot_bar_rew_TS])
        offset_X = 0.1 * max_lim
        plt.xlim([0, max_lim + offset_X])
        plot_bar_rew_TS[ad_TS].set_width(plot_bar_rew_TS[ad_TS].get_width() + reward_TS)
